...
const MATCH_TYPE = exports.MATCH_TYPE = {
  STRICT: 'strict',
...
const MATCH_NO = exports.MATCH_NO = new MatchingResult(MATCH_TYPE.NO);
const MATCH_STRICT = exports.MATCH_STRICT = new MatchingResult(MATCH_TYPE.STRICT);
const MATCH_DEFAULT = exports.MATCH_DEFAULT = new MatchingResult(MATCH_TYPE.DEFAULT);
